...
export const RaceTrack: React.FC<RaceTrackProps> = ({ grid, userTeamName, lapTarget }) => {
  ...
  const getTrackPath = () => {
    const points = [
      ...
      // First chicane (Rettifilo Tribune) - right then left
      { x: 580, y: 400 },
      { x: 600, y: 390 },
      { x: 615, y: 375 },
      { x: 625, y: 360 },
      ...
      // Seconda Variante (second chicane) - left then right
      { x: 720, y: 115 },
      { x: 735, y: 125 },
      { x: 745, y: 140 },
      { x: 750, y: 160 },
      ...
      // Ascari chicane (left-right-left complex)
      { x: 485, y: 445 },
      { x: 470, y: 455 },
      { x: 460, y: 470 },
      { x: 455, y: 490 },
      ...
      // Parabolica (long sweeping right turn back to main straight)
      { x: 480, y: 445 },
      { x: 455, y: 455 },
      { x: 435, y: 470 },
      { x: 420, y: 490 },
